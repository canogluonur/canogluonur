...
### 🎯 Core Infrastructure
```
Kubernetes • Docker • Helm • RKE • Longhorn
```
<p align="left">
...
```
AWS • Azure • Terraform • Ansible • Bash
```
<p align="left">
...
### 📊 Observability Stack
```
Prometheus • Grafana • Loki • Tempo • Alertmanager • Kibana
```
<p align="left">
...
### 🔐 Security & Networking
```
HashiCorp Vault • Trivy • Nginx Gateway
```
<p align="left">
